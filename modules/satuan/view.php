          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            <thead>
              <tr>
                ...
                <th class="center">Nama Satuan</th>
                <th></th>
              </tr>
            </thead>
            <!-- tampilan tabel body -->
            ...
            $query = mysqli_query($mysqli, "SELECT id_satuan, nama_satuan 
                                          FROM is_satuan")
            ...
            while ($data = mysqli_fetch_assoc($query)) { 
              ...
              echo "<tr>
                      ...
                      <td width='80' class='center'>$data[id_satuan]</td>
                      <td width='80' class='center'>$data[nama_satuan]</td>
            ...
            ?>
                          <a data-toggle="tooltip" data-placement="top" title="Hapus" class="btn btn-danger btn-sm" href="modules/satuan/proses.php?act=delete&id=<?php echo $data['id_satuan'];?>" onclick="return confirm('Anda yakin ingin menghapus satuan <?php echo $data['nama_satuan']; ?> ?');">
