...
// jika user sudah login, maka jalankan perintah untuk insert, update, dan delete
    ...
    if ($_GET['act'] == 'insert') {
        if (isset($_POST['simpan'])) {
            ...
            // perintah query untuk menyimpan data ke tabel is_satuan
            $query = mysqli_query($mysqli, "INSERT INTO is_satuan(id_satuan, nama_satuan) 
    ...
    elseif ($_GET['act'] == 'update') {
        if (isset($_POST['simpan'])) {
            if (isset($_POST['id_satuan'])) {
                ...
                // perintah query untuk mengubah data pada tabel is_satuan
    ...
    elseif ($_GET['act'] == 'delete') {
        if (isset($_GET['id'])) {
            ...
            // perintah query untuk menghapus data dari tabel is_satuan
