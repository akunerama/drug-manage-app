      ...
      <div class="box box-primary">
        <div class="box-body">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            $query = mysqli_query($mysqli, "SELECT a.kode_transaksi, a.tanggal_masuk, a.expired_date, a.kode_obat, a.jumlah_masuk, 
            ...
            while ($data = mysqli_fetch_assoc($query)) { 
              ...
              $expired        = isset($data['expired_date']) ? $data['expired_date'] : '-';
              ...
              echo "<tr>
                      ...
                      <td width='80' class='center'>$expired</td>
