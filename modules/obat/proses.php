...
// jika user sudah login, maka jalankan perintah untuk insert, update, dan delete
    ...
    if ($_GET['act'] == 'insert') {
        if (isset($_POST['simpan'])) {
            ...
            $query = mysqli_query($mysqli, "INSERT INTO is_obat(kode_obat, nama_obat, satuan, stok, created_user, updated_user) 
                VALUES('$kode_obat', '$nama_obat', '$satuan', '0', '$created_user', '$created_user')")
        ...
        if (isset($_POST['simpan'])) {
            if (isset($_POST['kode_obat'])) {
                ...
                $kode_obat = mysqli_real_escape_string($mysqli, trim($_POST['kode_obat']));
                $nama_obat = mysqli_real_escape_string($mysqli, trim($_POST['nama_obat']));
                // $expired_date = mysqli_real_escape_string($mysqli, trim($_POST['expired_date']));
