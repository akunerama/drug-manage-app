...
<head>
  <meta charset="UTF-8">
  <title>Admin | Aplikasi Persediaan Obat</title>
  <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
  <meta name="description" content="Aplikasi Persediaan Obat pada xy">
  <meta name="author" content="Student Uinsa Intern" />

  <!-- favicon -->
  <link rel="shortcut icon" href="assets/img/BPK-icon.png" />
...
<body class="skin-blue fixed" style="background-color: #ffde21;">
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="?module=beranda" class="logo">
        ...
        <span style="font-size:21px">Persediaan Obat Poli</span>
      </a>
